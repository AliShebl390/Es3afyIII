...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="paramedic-home-header">
      ...
      <p id="text">Offline</p>
      <a href="http://es3afy.test/paramedic/profile">
        <img class="paramedic-img" src="/images/person.jpg" alt="" />
      </a>
    </div>
    <div id="map"></div>
    ...
    <div class="request-section">
      ...
      <div class="request-section3">
        <a href="http://es3afy.test/paramedic/after-paramedic-accept-request">
          <button style="cursor: pointer" class="accept-button">Accept</button>
        </a>
      </div>
    </div>
<script>
