...
<body>
    <div class="req-container">
        ...
        <div class="req-nav">
            <a href="completed-requests"><button class="button-custom">Co<span>mple</span>ted</button></a>
            <a href="canceled-requests"><button class="button-custom">Canceled</button></a>
        </div>
