...
<body>
    <div class="req-container">
        <div class="req-header">
            <a href="paramedicHome"><i class="fas fa-arrow-alt-left"></i></a>
            <h1><span>My</span> requests</h1>
        </div>
        <div class="req-nav">
            <a href="completed-requests"><button class="button-custom">Completed</button></a>
            <a href="canceled-requests"><button class="button-custom">Ca<span>ncel</span>ed</button></a>
        </div>
        <div class="req-content">
            <div class="req-process">
                <p>August 9, 2020 08:15</p>
                <img src="/images/114036_OOLOG5_493-addc1e3de358e864b1d75e1d62824864.jpg" alt="">
                <div class="bottom-process">
                    <p>User's name</p>
                    <p class="req-canceled">Canceled</p>
                    </div>
                </div>
            <div class="req-process">
                <p>August 9, 2020 08:15</p>
